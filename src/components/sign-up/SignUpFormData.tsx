...
const SignUpFormData: FC<SignUpFormProps> = ({ showCancel = true }) => {
  ...
  return (
    <>
      <h4>{t('dataAccess.title')}</h4>
      <SignUpMessage>{t('dataAccess.description')}</SignUpMessage>
      <Form onSubmit={handleSubmit(onSubmit)} className="grid">
        ...
        <span className="col-12 text-xs">{t('dataAccess.consentMessage')}</span>
